...
| `get_page_by_printed_number` | Printed `(volume, page)` → shamela page (`/ajax/pagenum2id`); hadith numbers printed on the page when the edition/page provides evidence |
